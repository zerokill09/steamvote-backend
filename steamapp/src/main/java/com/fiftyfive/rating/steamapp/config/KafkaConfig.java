package com.fiftyfive.rating.steamapp.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "ec2-3-34-143-176.ap-northeast-2.compute.amazonaws.com:9092");
    ...
    public ProducerFactory<String, String> producerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "ec2-3-34-143-176.ap-northeast-2.compute.amazonaws.com:9092");
    ...
    public ConcurrentMessageListenerContainer<String, String> replyContainer(ConcurrentKafkaListenerContainerFactory<String, String> replyKafkaListenerContainerFactory) {
        ConcurrentMessageListenerContainer<String, String> replyContainer = replyKafkaListenerContainerFactory.createContainer("res_apps_liked");
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> replyKafkaListenerContainerFactory(KafkaTemplate<String, String> kafkaTemplate) {
        ConcurrentKafkaListenerContainerFactory<String, String> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerFactory());
